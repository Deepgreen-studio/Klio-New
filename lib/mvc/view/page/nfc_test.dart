...
class NfcTestState extends State<NfcTest> {
  ...
  _tagRead()  {
    Utils.showSnackBar("Reading start 00");
    try{
      NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
        Utils.showSnackBar("Reading start");
  /*      result.value = tag.data;
        Utils.showSnackBar(tag.data.toString());
        Utils.showSnackBar("end of writing");
  ...
  void _ndefWrite() {
    Utils.showSnackBar("writing start 00");
    NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
      Utils.showSnackBar("Start writing");
      ...
      try {
        Utils.showSnackBar("Start writing 222");
        await ndef.write(message);
        result.value = 'Success to "Ndef Write"';
        NfcManager.instance.stopSession();
      } catch (e) {
        Utils.showSnackBar("Writing error");
        result.value = e;
